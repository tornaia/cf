...
jextract --source -C "--verbose" -d src\main\java --target-package com.github.tornaia.cf.win.cfapi.internal "C:\Program Files (x86)\Windows Kits\10\Include\10.0.19041.0\um\cfapi.h"
